...
class _LogistiqueNavState extends State<LogistiqueNav> {
  final DashboardLogController dashboardLogController = Get.find();
  bool isOpen = false;
  bool isOpen1 = false;
  bool isOpen2 = false;
  bool isOpen3 = false;
  ...
  Widget build(BuildContext context) {
    ...
    return ExpansionTile(
      ...
      initiallyExpanded:
          widget.departementList.contains('Logistique') ? true : false,
      ...
      children: [
        if (userRole <= 2)
          DrawerWidget(
              ...
              style: bodyText1!,
              onTap: () {
                dashboardLogController.getData();
        ...
        if (widget.departementList.contains('Logistique') && userRole <= 2)
          DrawerWidget(
              ...
              style: bodyText1!,
              badge: Obx(() => Badge(
                    showBadge: (int.parse(widget.controller.itemLogCount) >= 1)
                        ? true
                        : false,
        ...
        DrawerWidget(
            selected: widget.currentRoute == LogistiqueRoutes.logEtatMateriel,
