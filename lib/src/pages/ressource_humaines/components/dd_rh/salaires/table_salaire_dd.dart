...
class TableSalaireDD extends StatefulWidget {
  const TableSalaireDD({super.key, required this.salaireController});
  final SalaireController salaireController;

  @override
  State<TableSalaireDD> createState() => _TableSalaireDDState();
}

class _TableSalaireDDState extends State<TableSalaireDD> {
