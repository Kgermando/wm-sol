...
class TableTransportRestDD extends StatefulWidget {
  const TableTransportRestDD(
      {super.key, required this.transportRestController});

  final TransportRestController transportRestController;

  @override
  State<TableTransportRestDD> createState() => _TableTransportRestDDState();
}

class _TableTransportRestDDState extends State<TableTransportRestDD> {
      ...
      child: PlutoGrid(
        ...
        onRowDoubleTap: (PlutoGridOnRowDoubleTapEvent tapEvent) async {
          ...
          final TransportRestaurationModel transportRestaurationModel =
              await widget.transportRestController.detailView(idPlutoRow.value);
