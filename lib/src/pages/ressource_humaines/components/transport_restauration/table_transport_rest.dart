...
class TableTransportRest extends StatefulWidget {
  const TableTransportRest(
      {Key? key, required this.transportRestList, required this.controller})
      : super(key: key);
  final List<TransportRestaurationModel> transportRestList;
  final TransportRestController controller;

  @override
  State<TableTransportRest> createState() => _TableTransportRestState();
}

class _TableTransportRestState extends State<TableTransportRest> {
            ...
            Row(
              children: [
                ...
                PrintWidget(onPressed: () {
                  TransportRestXlsx().exportToExcel(widget.transportRestList);
                  if (!mounted) return;
  ...
  Future<List<PlutoRow>> agentsRow() async {
    ...
    List.generate(widget.transportRestList.length, (index) {
      var item = widget.transportRestList[index];
