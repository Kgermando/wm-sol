...
class TableMobilierDD extends StatefulWidget {
  const TableMobilierDD({super.key, required this.mobilierController});
  final MobilierController mobilierController;
      ...
      child: PlutoGrid(
        ...
        onRowDoubleTap: (PlutoGridOnRowDoubleTapEvent tapEvent) async {
          ...
          final MobilierModel mobilierModel =
              await widget.mobilierController.detailView(idPlutoRow.value);
