...
class TableEntretienDD extends StatefulWidget {
  const TableEntretienDD({super.key, required this.entretienController});
  final EntretienController entretienController;
      ...
      child: PlutoGrid(
        ...
        onRowDoubleTap: (PlutoGridOnRowDoubleTapEvent tapEvent) async {
          ...
          final EntretienModel entretienModel =
              await widget.entretienController.detailView(idPlutoRow.value);
