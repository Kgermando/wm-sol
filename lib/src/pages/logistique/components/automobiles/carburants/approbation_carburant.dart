...
class ApprobationCarburant extends StatefulWidget {
  const ApprobationCarburant(
      {super.key,
      required this.data,
      required this.controller,
      required this.profilController});
  final CarburantModel data;
  final CarburantController controller;
  final ProfilController profilController;

  @override
  State<ApprobationCarburant> createState() => _ApprobationCarburantState();
}

class _ApprobationCarburantState extends State<ApprobationCarburant> {
  @override
  ...
  Widget approbationDDWidget(CarburantController controller) {
  ...
  Widget motifDDWidget(CarburantController controller) {
    return Container(
      margin: const EdgeInsets.only(bottom: p10),
      child: Row(
        children: [
