...
class ApprobationImmobilier extends StatefulWidget {
  const ApprobationImmobilier(
      {super.key,
      required this.data,
      required this.controller,
      required this.profilController});
  final ImmobilierModel data;
  final ImmobilierController controller;
  final ProfilController profilController;

  @override
  State<ApprobationImmobilier> createState() => _ApprobationImmobilierState();
}

class _ApprobationImmobilierState extends State<ApprobationImmobilier> {
  @override
  ...
  Widget approbationDGWidget(ImmobilierController controller) {
  ...
  Widget motifDGWidget(ImmobilierController controller) {
    return Container(
        margin: const EdgeInsets.only(bottom: p10),
        child: Row(
          children: [
