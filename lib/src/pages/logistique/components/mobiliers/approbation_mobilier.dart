...
class ApprobationMobilier extends StatefulWidget {
  const ApprobationMobilier(
      {super.key,
      required this.data,
      required this.controller,
      required this.profilController});
  final MobilierModel data;
  final MobilierController controller;
  final ProfilController profilController;

  @override
  State<ApprobationMobilier> createState() => _ApprobationMobilierState();
}

class _ApprobationMobilierState extends State<ApprobationMobilier> {
  @override
  ...
  Widget approbationDDWidget(MobilierController controller) {
  ...
  Widget motifDDWidget(MobilierController controller) {
    return Container(
      margin: const EdgeInsets.only(bottom: p10),
      child: Row(
        children: [
