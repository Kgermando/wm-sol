...
class TableBudgetPrevisionnelDG extends StatefulWidget {
  ...
  State<TableBudgetPrevisionnelDG> createState() =>
      _TableBudgetPrevisionnelDGState();
}

class _TableBudgetPrevisionnelDGState extends State<TableBudgetPrevisionnelDG> {
        ...
        createHeader: (PlutoGridStateManager header) {
          return Row(
            ...
            children: [
              ...
              IconButton(
                  onPressed: () {
                    widget.budgetPrevisionnelController.getList();
  ...
  Future<List<PlutoRow>> agentsRow() async {
    var dataList = widget.budgetPrevisionnelController.departementBudgetList
        .where((element) =>
