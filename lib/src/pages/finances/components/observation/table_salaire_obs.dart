...
class TableSalaireObs extends StatefulWidget {
  const TableSalaireObs({super.key, required this.salaireController});
  final SalaireController salaireController;

  @override
  State<TableSalaireObs> createState() => _TableSalaireObsState();
}

class _TableSalaireObsState extends State<TableSalaireObs> {
