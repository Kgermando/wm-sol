...
class TableDettePaiement extends StatefulWidget {
  const TableDettePaiement(
      {super.key, required this.controller, required this.detteModel});
  final CreanceDetteController controller;
  final DetteModel detteModel;

  @override
  State<TableDettePaiement> createState() => _TableDettePaiementState();
}
      ...
      child: PlutoGrid(
        ...
        createHeader: (PlutoGridStateManager header) {
          return Row(
            ...
            children: [
              const TitleWidget(title: "Paiement"),
              Row(
                children: [
                  IconButton(
                      onPressed: () {
