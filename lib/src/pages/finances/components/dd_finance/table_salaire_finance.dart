...
class TableSalaireFinance extends StatefulWidget {
  const TableSalaireFinance({super.key, required this.salaireController});
  final SalaireController salaireController;

  @override
  State<TableSalaireFinance> createState() => _TableSalaireFinanceState();
}

class _TableSalaireFinanceState extends State<TableSalaireFinance> {
      ...
      child: PlutoGrid(
        ...
        onRowDoubleTap: (PlutoGridOnRowDoubleTapEvent tapEvent) async {
          ...
          final PaiementSalaireModel dataItem =
              await widget.salaireController.detailView(idPlutoRow.value);
