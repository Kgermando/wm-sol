...
class ApprobationSuccursale extends StatefulWidget {
  const ApprobationSuccursale(
      {super.key,
      required this.data,
      required this.controller,
      required this.profilController});
  final SuccursaleModel data;
  final SuccursaleController controller;
  final ProfilController profilController;

  @override
  State<ApprobationSuccursale> createState() => _ApprobationSuccursaleState();
}

class _ApprobationSuccursaleState extends State<ApprobationSuccursale> {
  @override
