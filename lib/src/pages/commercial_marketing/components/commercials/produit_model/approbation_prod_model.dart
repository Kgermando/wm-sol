...
class ApprobationProdModel extends StatefulWidget {
  const ApprobationProdModel(
      {super.key,
      required this.data,
  ...
  @override
  State<ApprobationProdModel> createState() => _ApprobationProdModelState();
}

class _ApprobationProdModelState extends State<ApprobationProdModel> {
  @override
  ...
  Widget approbationDDWidget(ProduitModelController controller) {
  ...
  Widget motifDDWidget(ProduitModelController controller) {
    return Container(
      margin: const EdgeInsets.only(bottom: p10),
      child: Row(
        children: [
