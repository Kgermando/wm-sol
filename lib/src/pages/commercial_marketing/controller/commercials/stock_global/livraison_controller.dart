...
class LivraisonController extends GetxController {
  ...
  void submit(StocksGlobalMOdel stock) async {
    try {
      ...
      await stockGlobalController.stockGlobalApi.updateData(stocksGlobalMOdel).then((value) async {
        ...
        await bonLivraisonController.bonLivraisonApi.insertData(bonLivraisonModel).then((value) {
