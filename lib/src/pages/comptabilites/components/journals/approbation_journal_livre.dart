...
class ApprobationJournalLivre extends StatefulWidget {
  const ApprobationJournalLivre(
      {super.key,
      required this.data,
      required this.controller,
      required this.profilController});
  final JournalLivreModel data;
  final JournalLivreController controller;
  final ProfilController profilController;

  @override
  State<ApprobationJournalLivre> createState() => _ApprobationJournalLivreState();
}

class _ApprobationJournalLivreState extends State<ApprobationJournalLivre> {
  @override
  ...
  Widget approbationDDWidget(JournalLivreController controller) {
  ...
  Widget motifDDWidget(JournalLivreController controller) {
    return Container(
      margin: const EdgeInsets.only(bottom: p10),
      child: Row(
        children: [
