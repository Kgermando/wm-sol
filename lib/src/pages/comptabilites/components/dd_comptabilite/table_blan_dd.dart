...
class TableCompteBilanDD extends StatefulWidget {
  const TableCompteBilanDD({super.key, required this.bilanController});
  final BilanController bilanController;

  @override
  State<TableCompteBilanDD> createState() => _TableCompteBilanDDState();
}

class _TableCompteBilanDDState extends State<TableCompteBilanDD> {
      ...
      child: PlutoGrid(
        ...
        onRowDoubleTap: (PlutoGridOnRowDoubleTapEvent tapEvent) async {
          ...
          final BilanModel bilanModel =
              await widget.bilanController.detailView(idPlutoRow.value);
              ...
              Row(
                children: [
                  ...
                  PrintWidget(onPressed: () {
                    BilanXlsx().exportToExcel(widget.bilanController.bilanList);
                    if (!mounted) return;
