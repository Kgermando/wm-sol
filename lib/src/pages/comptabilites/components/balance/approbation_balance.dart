...
class ApprobationBalance extends StatefulWidget {
  const ApprobationBalance(
      {super.key,
      required this.data,
      required this.controller,
      required this.profilController});
  final BalanceCompteModel data;
  final BalanceController controller;
  final ProfilController profilController;

  @override
  State<ApprobationBalance> createState() => _ApprobationBalanceState();
}

class _ApprobationBalanceState extends State<ApprobationBalance> {
  @override
  ...
  Widget approbationDDWidget(BalanceController controller) {
  ...
  Widget motifDDWidget(BalanceController controller) {
    return Container(
      margin: const EdgeInsets.only(bottom: p10),
      child: Row(
        children: [
